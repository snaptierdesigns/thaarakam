      ...
      <div className="mx-auto flex h-16 max-w-[1280px] items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <nav className="hidden lg:flex lg:gap-x-8">
          ...
          <Link
            href="/reviews"
            className={`text-sm font-medium transition-colors hover:text-foreground/80 ${
              pathname === '/reviews' ? 'text-foreground font-semibold' : 'text-secondary'
            }`}
          >
            Reviews
          </Link>
          <Link
            href="/track-order"
            className={`text-sm font-medium transition-colors hover:text-foreground/80 ${
              pathname === '/track-order' ? 'text-foreground font-semibold' : 'text-secondary'
            }`}
          >
            Track Order
          </Link>
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden border-t border-border bg-background px-4 py-4 shadow-lg animate-fadeIn duration-200">
          <div className="flex flex-col gap-y-4">
            ...
            <Link
              href="/track-order"
              className={`text-sm font-medium ${pathname === '/track-order' ? 'text-foreground font-semibold' : 'text-secondary'}`}
            >
              Track Order
            </Link>
            <Link
